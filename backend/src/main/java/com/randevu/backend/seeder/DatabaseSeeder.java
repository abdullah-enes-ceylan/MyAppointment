...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (userRepository.count() > 0) {
            System.out.println("⏭️  Veritabanında veri mevcut, seeder atlanıyor.");
            return;
        }
        ...
        Business b1 = saveBusiness("Stil Kuaför", "Bağdat Caddesi No:45, Kadıköy", "02161234567",
                "Modern saç tasarım stüdyosu", adminUser, "09:00", "20:00", BusinessCategory.HAIRDRESSER);
        Business b2 = saveBusiness("Makas Atölyesi", "İstiklal Caddesi No:120, Beyoğlu", "02129876543",
                "Profesyonel saç bakım merkezi", adminUser, "08:30", "19:30", BusinessCategory.HAIRDRESSER);
        ...
        Business b5 = saveBusiness("Glow Beauty Studio", "Bağdat Cad. No:200, Kadıköy", "02163456789",
                "Cilt bakımı ve güzellik uzmanı", adminUser, "10:00", "19:00", BusinessCategory.BEAUTY_SALON);
        Business b6 = saveBusiness("Elmas Güzellik Salonu", "Kızılay Meydanı No:5, Ankara", "03125678901",
                "Premium güzellik hizmetleri", adminUser, "09:30", "20:30", BusinessCategory.BEAUTY_SALON);

        // --- SPA_WELLNESS ---
        Business b7 = saveBusiness("Zen Spa & Masaj", "Çeşme Marina, İzmir", "02326789012",
                "Huzur ve rahatlama merkezi", adminUser, "10:00", "22:00", BusinessCategory.SPA_WELLNESS);
        ...
        Business b9 = saveBusiness("Tırnak Sanatı Stüdyo", "Alsancak Kordon No:15, İzmir", "02328901234",
                "Yaratıcı tırnak tasarımları", adminUser, "10:00", "19:00", BusinessCategory.NAIL_STUDIO);
        Business b10 = saveBusiness("Parlak Tırnaklar", "Cevahir AVM Kat:3, İstanbul", "02129012345",
                "Profesyonel nail art merkezi", adminUser, "10:30", "21:30", BusinessCategory.NAIL_STUDIO);

        // --- MAKEUP_STUDIO ---
        Business b11 = saveBusiness("Glamour Makyaj Stüdyo", "Nişantaşı Valikonağı Cad. No:7", "02120123456",
                "Düğün ve özel gün makyajı", adminUser, "09:00", "18:00", BusinessCategory.MAKEUP_STUDIO);
        Business b12 = saveBusiness("Rouge Beauty Lab", "Bostancı Köprüsü Yanı No:22", "02161234568",
                "Profesyonel makyaj uygulamaları", adminUser, "10:00", "19:00", BusinessCategory.MAKEUP_STUDIO);

        // --- TATTOO_STUDIO ---
        Business b13 = saveBusiness("İnk Master Tattoo", "Kadıköy Moda Cad. No:55", "02162345679",
                "Özel tasarım dövme stüdyosu", adminUser, "12:00", "22:00", BusinessCategory.TATTOO_STUDIO);
        Business b14 = saveBusiness("Black Needle Studio", "Karaköy Mumhane Cad. No:18", "02123456780",
                "Minimal ve fine-line dövme uzmanı", adminUser, "11:00", "21:00", BusinessCategory.TATTOO_STUDIO);
